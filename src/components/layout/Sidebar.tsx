    ...
    <aside className="w-72 min-h-screen border-r border-[rgba(15,23,42,0.08)] bg-[rgba(240,249,255,0.80)] backdrop-blur-xl flex flex-col">
        ...
        <div className="glass-panel rounded-[28px] p-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="font-semibold text-slate-800 leading-none mt-1">
                Clinical Console
              </p>
            </div>
          </div>
      ...
      <div className="px-6 py-3 border-b border-[rgba(15,23,42,0.08)]">
        <div className="flex items-center gap-2.5">
          ...
          />
          <span className="font-mono-ui text-[10px] uppercase tracking-[0.22em] text-slate-400">
            Padronização ISAK
          </span>
        </div>
      </div>
      ...
      <div className="p-4 border-t border-[rgba(15,23,42,0.08)] space-y-3">
        {uso && uso.plano === "FREE" && uso.limite && (
          <Link
            href="/conta"
            className="block glass-panel rounded-2xl p-4 hover:opacity-90 transition-opacity"
          >
            ...
            <div className="h-1 w-full rounded-full bg-slate-200 overflow-hidden">
              <div
                ...
                style={{
                  width: `${Math.min((uso.totalPacientes / uso.limite) * 100, 100)}%`,
                }}
              />
            </div>
          </Link>
