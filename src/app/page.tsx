  ...
  return (
    <main className="min-h-screen hero-grid flex flex-col px-4 py-4 md:px-6 md:py-6">
      <div className="glass-panel-strong flex min-h-[calc(100vh-2rem)] flex-col rounded-[36px]">
        ...
        <section className="flex-1 grid gap-10 px-6 py-10 md:grid-cols-[1.2fr_0.8fr] md:px-8 md:py-14">
          <div className="flex flex-col justify-center">
            ...
            <h1 className="max-w-3xl text-5xl font-semibold tracking-[-0.05em] text-slate-900 md:text-7xl">
              ...
              <span className="block text-[color:var(--accent)]">
                clínica, legível e estratégica.
              </span>
            </h1>

            <p className="mt-6 max-w-2xl text-lg leading-8 text-slate-600">
              Organize fórmulas, acompanhe evolução corporal e conduza
              atendimentos com um painel que parece instrumento de trabalho, não
            ...
            <div className="mt-12 grid grid-cols-1 sm:grid-cols-3 gap-4 max-w-3xl w-full">
              {[
                [
                  "Protocolos",
                  "Petroski, Faulkner, Heath-Carter e Lee no mesmo fluxo.",
                ],
                [
                  "Histórico",
                  "Evolução visual do paciente com leitura rápida por consulta.",
                ],
                [
                  "Paciente",
                  "Compartilhe resultados e acompanhe retorno sem ruído operacional.",
                ],
              ].map(([titulo, desc]) => (
                <div key={titulo} className="glass-panel rounded-[24px] p-5">
                  <p className="font-mono-ui text-[11px] uppercase tracking-[0.24em] text-slate-500">
                    {titulo}
                  </p>
          ...
          <div className="flex items-center">
            <div className="glass-panel-strong w-full rounded-[32px] p-5 md:p-6">
              <div className="flex items-center justify-between border-b border-[rgba(23,32,51,0.08)] pb-4">
                <div>
                  <p className="font-mono-ui text-[11px] uppercase tracking-[0.26em] text-slate-500">
                    Session Board
                  </p>
              ...
              <div className="mt-5 grid gap-4">
                {[
                  ...
                  <div
                    key={item.k}
                    className={`metric-card rounded-[26px] bg-gradient-to-br ${item.tone} p-5 text-white`}
                  >
                    <p className="font-mono-ui text-[11px] uppercase tracking-[0.24em] text-white/70">
                      {item.k}
                    </p>
          ...
          <div className="md:col-span-2 mt-2 grid grid-cols-1 sm:grid-cols-3 gap-6 w-full">
            {[
              ...
              >
                <div className="font-mono-ui text-sm mb-4 text-[color:var(--accent)]">
                  {f.icon}
                </div>
        ...
        {/* Pricing */}
        <section className="px-6 py-14 md:px-8 md:py-20 border-t border-[rgba(23,32,51,0.07)]">
          <div className="text-center mb-12">
            <div className="eyebrow mb-4">Planos</div>
            <h2 className="text-4xl font-semibold tracking-[-0.04em] text-slate-900 md:text-5xl">
              Simples e direto.
            </h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 max-w-3xl mx-auto">
            ...
            <div className="glass-panel rounded-[32px] p-8 flex flex-col">
              ...
              <div className="mt-4 flex items-end gap-1">
                <span className="text-5xl font-semibold text-slate-900 tracking-[-0.04em]">
                  R$&nbsp;0
                </span>
              </div>
              <p className="mt-2 text-sm text-slate-500">Para sempre</p>

              <ul className="mt-8 flex flex-col gap-3 flex-1">
                {[
                  "Até 5 pacientes",
                  "Todas as fórmulas científicas",
              ...
              <Link
                href="/cadastro"
                className="mt-8 px-5 py-3 rounded-2xl border border-[rgba(23,32,51,0.12)] text-slate-700 font-semibold text-sm text-center hover:bg-[rgba(23,32,51,0.04)] transition-colors"
              >
                Criar conta grátis
              </Link>
            </div>
            ...
            {/* Pro */}
            <div className="relative rounded-[32px] p-8 flex flex-col bg-[linear-gradient(145deg,#1f8a70,#264653)] shadow-[0_24px_56px_rgba(31,138,112,0.28)]">
              <div className="absolute top-6 right-6 rounded-full bg-white/20 px-3 py-1 text-[11px] font-semibold text-white uppercase tracking-[0.2em]">
                Popular
              </div>
              <p className="font-mono-ui text-[11px] uppercase tracking-[0.28em] text-white/60">
                Pro
              </p>
              <div className="mt-4 flex items-end gap-1">
                <span className="text-xl font-medium text-white/60 mb-2">
                  R$
                </span>
                <span className="text-5xl font-semibold text-white tracking-[-0.04em]">
                  22
                </span>
                <span className="text-2xl font-semibold text-white/80 mb-1">
                  ,90
                </span>
              </div>
              <p className="mt-2 text-sm text-white/60">por mês</p>
              ...
              <ul className="mt-8 flex flex-col gap-3 flex-1">
                {[
                  ...
                  >
                    <span className="h-2 w-2 rounded-full bg-white/50 shrink-0" />
                    {item}
                  </li>
                ))}
              </ul>
              ...
              <Link
                href="/cadastro"
                className="mt-8 px-5 py-3 rounded-2xl bg-white text-[#1f8a70] font-semibold text-sm text-center hover:opacity-90 transition-opacity shadow-[0_8px_24px_rgba(0,0,0,0.12)]"
              >
                Começar agora
              </Link>
            </div>
