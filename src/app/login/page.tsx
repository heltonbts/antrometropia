        ...
        <div className="hidden flex-col justify-between border-r border-[rgba(15,23,42,0.08)] bg-[linear-gradient(160deg,rgba(6,182,212,0.12),rgba(255,255,255,0.18),rgba(37,99,235,0.12))] p-8 md:flex">
          <div>
            ...
            <div className="mt-16">
              ...
              <p className="mt-6 max-w-md text-base leading-7 text-slate-600">
                Acesso rápido ao histórico do paciente, avaliações em andamento
                e composição corporal validada.
              </p>
            </div>
          </div>
          ...
          <div className="grid gap-4">
            {[
              ...
              <div
                key={item}
                className="glass-panel rounded-[22px] px-4 py-4 text-sm text-slate-700"
              >
                {item}
              </div>
            ))}
          ...
          <div className="w-full max-w-md">
            ...
            <div className="mb-8">
              ...
              <p className="mt-3 text-sm leading-6 text-slate-500">
                Entre com sua conta para continuar o fluxo de avaliação.
              </p>
            </div>
